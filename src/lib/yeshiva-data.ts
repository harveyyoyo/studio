...
export const YESHIVA_DATA: Omit<Database, 'passcode'> = {
  ...
  coupons: [
    ...
    { id: 'CHESED-150', code: 'CHESED-150', value: 150, category: 'Chesed', teacher: 'Rabbi Levi', used: true, createdAt: Date.now() - 86400000 * 5, usedBy: 'Avi Schwartz', usedAt: Date.now() - 86400000 * 2},
