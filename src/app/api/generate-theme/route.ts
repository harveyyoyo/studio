...
export async function POST(req: NextRequest) {
    try {
        ...
        const systemInstruction = `You are an expert UI/UX designer. Your task is to generate a beautiful, modern color palette for a student web portal based on the user's prompt.
...
You must also include a single cohesive 'emoji' that accurately represents the theme.
...
Required schema:
{
  ...
  "primary": "A hex color for primary buttons and main accents",
  "cardBackground": "A hex color for content cards that sit on the background",
  "accent": "A secondary accent color for borders or secondary icons",
